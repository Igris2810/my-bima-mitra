...
const CSS = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  /* ---- Call Float - MOVED TO BOTTOM LEFT ---- */
  .call-float { position: fixed; bottom: 24px; left: 24px; z-index: 200; background: var(--navy); color: white; padding: 12px 18px; border-radius: 100px; font-weight: 700; font-size: 14px; box-shadow: 0 6px 20px rgba(11,61,145,0.4); transition: transform .2s; display: flex; align-items: center; gap: 6px; }
...
export default function App() {
  ...
  useEffect(() => {
    // Setup Google Translate Script (Only loads once)
